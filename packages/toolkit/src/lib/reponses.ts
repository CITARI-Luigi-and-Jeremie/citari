  ...
  return [
...

    {
      ...
      texte: bloc(
        ...
        `Et avant ça, le diagnostic complet est offert : les 6 moteurs, ${i.totalQueries === 20 ? 24 : i.totalQueries} questions, l'audit technique de votre site. Vous repartez avec, que vous travailliez avec nous ou non.`,
        `${BOOKING()}`,
        fin(),
      ),
    },

    {
      ...
      texte: bloc(
        ...
        `Le diagnostic fait ressortir vos questions perdues, les sources qui font gagner ${rival}, et l'état technique de votre site. Ce sont des données brutes : sans quelqu'un pour vous dire lesquelles comptent dans votre cas, ça reste un tableau de chiffres.`,
        `Je vous propose l'inverse : trente minutes où je vous montre le diagnostic, et je vous envoie ensuite un écrit qui reprend ce dont on a parlé. Comme ça votre associé ou votre équipe reçoit un document qui a du sens.`,
        `${BOOKING()}`,
        fin(),
      ),
    },

    {
      ...
      texte: bloc(
        ...
        `Le diagnostic complet est offert et il ne vous engage à rien. S'il montre que votre agence couvre déjà le sujet, je vous le dirai et vous aurez au moins la preuve que c'est bien fait.`,
        `${BOOKING()}`,
        fin(),
      ),
    },
