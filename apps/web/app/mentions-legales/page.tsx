...
export default function MentionsLegalesPage() {
  return (
    <main className="mx-auto max-w-prose space-y-8 px-4 py-16">
      ...
      <h1 className="font-editorial text-3xl text-bone">Mentions légales</h1>

      <section className="space-y-2">
        <h2 className="font-editorial text-xl text-bone">Éditeur du site</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-editorial text-xl text-bone">Hébergement</h2>
        <p className="text-bone-dim">
      ...
      <section className="space-y-2">
        <h2 className="font-editorial text-xl text-bone">Propriété intellectuelle</h2>
        <p className="text-bone-dim">
      ...
      <section className="space-y-2">
        <h2 className="font-editorial text-xl text-bone">Limitation de responsabilité</h2>
        <p className="text-bone-dim">
      ...
      <section className="space-y-2">
        <h2 className="font-editorial text-xl text-bone">Médiation de la consommation</h2>
        <p className="text-bone-dim">
