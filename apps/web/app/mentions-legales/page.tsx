    ...
    <main className="mx-auto max-w-3xl space-y-6 px-4 py-12">
      ...
      <section className="space-y-2">
        ...
        <p className="text-slate-700">
          ...
          <br />Contact : <a className="text-accent underline" href="mailto:[À COMPLÉTER]">[À COMPLÉTER : email]</a>
        </p>
      </section>
      ...
      <p className="pt-4 text-sm text-slate-500">
        Voir également notre <a className="text-accent underline" href="/confidentialite">politique de confidentialité</a>.
      </p>
    </main>
  );
}
